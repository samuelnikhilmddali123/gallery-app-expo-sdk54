...
function ZoomableImage({ source, style, contentFit = 'contain', onZoomChange, intrinsicWidth, intrinsicHeight, recyclingKey, isActive = true, onPress, containerWidth: propContainerWidth, containerHeight: propContainerHeight }) {
  // Shared values
